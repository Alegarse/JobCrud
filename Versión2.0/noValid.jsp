            ...
            <div class="jumbotron jumbotron text-dark bg-warning">
                <div class="container">
                    ...
                    <div class="card-body text-center">
                        <h4 class="card-title text-center text-danger text-bold">Error. Usuario aún no validado.</h5>
                            <hr>
                            <p class="card-text text-center">Ha introducido un 
                                nombre de usuario registrado cuya incorporación a nuestra base de datos
                                está pendiente de aprobar por el administrador.
                                Este tiempo de activación puede ser de hasta 24 hrs. </p>
