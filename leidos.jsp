    ...
    <body>
        ...
        <div class="container">
            <div class="jumbotron jumbotron text-dark bg-warning">
                <div class="container">
                    <h1 class="display-4">Books Crud - Libros leidos</h1>
        ...
        <%
            ResultSet listado = s.executeQuery("SELECT * FROM leidos");
        ...
        <div class="container-fluid">
            ...
            <table class="table table-striped table-dark text-center">
                ...
                <form method="get" action="grabalibroL.jsp">
                    <tr><td><input type="" name="isbn" size="13"></td>
                        <td><input type="text" name="autor" size="15"></td>
                        <td><input type="text" name="titulo" size="25"></td>
                        <td><input type="longtext" name="sinopsis" size="60"></td>
                        <td><input type="int" name="fecha" size="6"></td>
                ...
                <td>
                    <form method="get" action="editalibroL.jsp">
                ...
                <td>
                    <form method="get" action="borralibroL.jsp">
                        <input type="hidden" name="isbn" value="<%=listado.getString("isbn")%>"/>
