...
- Soporta introducción,edicción y borrado de libros en panel admin;
...
- Gesti�n completa de usuarios: Nuevos, ya existentes, si est�n validados, si son usuarios normales o admin, creaci�n de tablas para cada usuario una vez validado su acceso.
