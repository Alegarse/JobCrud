...
<html>
    ...
    <body>
        <%
            ...
            String existeLibro = "SELECT * FROM sugeridos WHERE isbn=" + request.getParameter("isbn");
            ...
            if (numLibro.getRow() != 0) { //Al contener fila indicaría que ya está en la BBDD
                ...
                String grabacion = "INSERT INTO sugeridos (isbn, autor, titulo, sinopsis, fecha) ";
                grabacion += "VALUES ('";
        ...
        <script>
            // Volvemos al index
            location.replace("sugeridos.jsp");
        </script>
    </body>
</html>
