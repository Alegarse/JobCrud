    ...
    <body>
        ...
        <div class="container">
            <div class="jumbotron jumbotron text-dark bg-warning">
                <div class="container">
                    <h1 class="display-4">Books Crud - Libros pendientes de leer</h1>
        ...
        <%
            ResultSet listado = s.executeQuery("SELECT * FROM porleer");
        ...
        <div class="container-fluid">
            ...
            <table class="table table-striped table-dark text-center">
                ...
                <td>
                    <form method="get" action="editalibroPL.jsp">
                ...
                <td>
                    <form method="get" action="borralibroPL.jsp">
                        <input type="hidden" name="isbn" value="<%=listado.getString("isbn")%>"/>
