...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2019 a las 17:47:52
...
INSERT INTO `libros` (`ISBN`, `Autor`, `Titulo`, `Sinopsis`, `Fecha`) VALUES
...
--
-- Estructura de tabla para la tabla `prueba1_fav`
--

CREATE TABLE `prueba1_fav` (
  `ISBN` bigint(20) NOT NULL,
...
--
-- Volcado de datos para la tabla `prueba1_fav`
--

INSERT INTO `prueba1_fav` (`ISBN`, `Autor`, `Titulo`) VALUES
(9788417305659, 'Soren Sveistrup', 'El caso hartung'),
(9788466343039, 'Arturo Pérez Reverte', 'Falcó');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `prueba1_prest`
--

CREATE TABLE `prueba1_prest` (
  `ISBN` bigint(20) NOT NULL,
  `Autor` varchar(40) DEFAULT NULL,
  `Titulo` varchar(60) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Volcado de datos para la tabla `prueba1_prest`
--

INSERT INTO `prueba1_prest` (`ISBN`, `Autor`, `Titulo`) VALUES
(9788491291893, 'Elisabet Benavent', 'Toda la verdad sobre las mentiras');
...
CREATE TABLE `usuarios` (
  ...
  `tipo` varchar(10) COLLATE utf8_spanish2_ci NOT NULL DEFAULT 'normal',
...
INSERT INTO `usuarios` (`usuario`, `clave`, `verificado`, `tipo`, `nombre`) VALUES
('alejandro', '41D3A2DFE4EAF21D4D4E5C65FFD1BF16', 1, 'admin', 'Alejandro Garcia Serrano'),
('prueba1', '3F1B7CCAD63D40A7B4C27DDA225BF941', 1, 'normal', 'Usuario de prueba 1');
...
--
-- Indices de la tabla `prueba1_fav`
--
ALTER TABLE `prueba1_fav`
  ADD PRIMARY KEY (`ISBN`);

--
-- Indices de la tabla `prueba1_prest`
--
ALTER TABLE `prueba1_prest`
  ADD PRIMARY KEY (`ISBN`);
COMMIT;
